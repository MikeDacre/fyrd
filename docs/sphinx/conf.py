...
latex_documents = [
    (master_doc, 'fyrd.tex', 'Fyrd Documentation',
     'Mike Dacre \\textless{}mike.dacre@gmail.com\\textgreater{}', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'Fyrd', 'Fyrd Documentation',
     author, 'Fyrd',
     'Submit functions and shell scripts to torque, slurm, or local ' +
     'machines using python. Make your code multithread on any cluster!',
     'Library'),
]
